      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-500">
            Search for creators by their username to show your support
          </p>
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">
              Empower Creators with Web3
            </p>
            <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
              Our platform connects creators directly with their supporters using blockchain technology
            </p>
          </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-white rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Direct Support</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Support creators directly with cryptocurrency. No middlemen, no delays.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-white rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-500">
                      Connect with creators and supporters from around the world.
                    </p>
                  </div>
                </div>
              </div>
